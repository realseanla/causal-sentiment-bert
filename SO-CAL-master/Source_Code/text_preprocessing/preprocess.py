...
class Preprocess():
    ...
    def output_preprocessed_data(self, json_input, file_name):
        '''
        Output preprocessed data_source into a file.
        :param json_input: json formatted data_source generated from function str_process
    ...
    def pos_tagging(self):
        '''
        Read an input file/folder as raw data_source input.
