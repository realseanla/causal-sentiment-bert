...
def get_command_arguments():
    ...
    parser.add_argument('--gold', '-g', type=str, dest='gold', action='store',
                        default='',
                        help="""The gold file,
                                but if your data_source files start with 'yes' or 'no', the gold file is not necessary
                             """)
...
def main():
    ...
    if gold_file == "":
        print("""
              Without gold data_source, the prediction accuracy will not be generated.
              To create gold data_source, either name your preprocessed data_source with "yes" or "no",
